...
add_library(ethkey STATIC ${CMAKE_SOURCE_DIR}/src/main.cpp) 
...
if (WIN32)
    set_property (TARGET ethkey APPEND PROPERTY STATIC_LIBRARY_FLAGS ${CMAKE_BINARY_DIR}/libsecp256k1.a ${CMAKE_BINARY_DIR}/libethkey-core.a)
...
elseif (UNIX)
    ...
    ADD_CUSTOM_COMMAND(TARGET ethkey
          ...
          COMMAND ${CMAKE_AR} x ${CMAKE_BINARY_DIR}/libethkey-core.a WORKING_DIRECTORY ${LIB_OBJ_DIR}
          COMMAND ${CMAKE_AR} rcs ${CMAKE_BINARY_DIR}/libethkey.a ${LIB_OBJ_DIR}/*.o
...
install(FILES ${CMAKE_BINARY_DIR}/include/ethkey/config.hpp DESTINATION include/ethkey)
